...
\begin{figure}[H]
  \centering
  \BeginAccSupp{method=escape,Alt={Gráfico que muestra la evolución de la capacidad instalada de generación eléctrica por tecnología durante el periodo 2020 a 2025}}
...
\begin{figure}[H]
  \centering
  \BeginAccSupp{method=escape,Alt={Gráfico que muestra la distribución del consumo final de energía por sector económico en el año 2024}}
...
\begin{figure}[H]
  \centering
  \BeginAccSupp{method=escape,Alt={Gráfico que muestra las emisiones de gases de efecto invernadero del sector energético y la contribución específica de la generación eléctrica}}
