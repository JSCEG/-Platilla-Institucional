...
\begin{tabladorado}
  ...
  \begin{tabular}{p{3cm}ccc}
    ...
    \midrule
    \textbf{Generación} & 1 & 2025 \textsuperscript{\textcolor{gray}{1/}} & 2026 \textsuperscript{\textcolor{gray}{2/}} \\
    \textbf{Distribucion} & 56 & 6 & 7 \\
    \textbf{olar Fotovoltaica \textsuperscript{\textcolor{gray}{3/}}} & 57 & 8 & 10 \\
    \bottomrule
  \end{tabular}
\end{tabladorado}
...
\begin{tabladoradoLargo}
  \begin{longtable}{p{3cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}}
    ...
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{\textbf{TECNOLOGÍA}} & \encabezadodorado{2014 \textsuperscript{\textcolor{gray}{1/}}} & \encabezadodorado{2015 \textsuperscript{\textcolor{gray}{1/}}} & \encabezadodorado{2016 \textsuperscript{\textcolor{gray}{1/,7/}}} & \encabezadodorado{2017 \textsuperscript{\textcolor{gray}{1/,11/}}} & \encabezadodorado{2018 \textsuperscript{\textcolor{gray}{1/,10/}}} \\
    \midrule
    \endfirsthead
    ...
    \textbf{Bioenergía \textsuperscript{\textcolor{gray}{2/}}} & 233.216 & 233.216 & 889 & 374.15 & 375.15 \\
    ...
    \textbf{Generación Distribuida (GD) \textsuperscript{\textcolor{gray}{8/}}} &  &  & 248 &  &  \\
    \textbf{FIRCO \textsuperscript{\textcolor{gray}{9/}}} & 0.3 & 12.5 & 13.6 &  &  \\
    ...
    \textbf{Térmica convencional \textsuperscript{\textcolor{gray}{3/}}} & 12,664.95 & 12,664.95 & 13,174 & 12,664.95 & 12,314.95 \\
    \textbf{Turbogás \textsuperscript{\textcolor{gray}{4/}}} & 2,398.734 & 2,848.734 & 5,052 & 2,959.814 & 2,959.814 \\
  ...
  \begin{longtable}{p{3cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{\textbf{TECNOLOGÍA}} & \encabezadodorado{2019 \textsuperscript{\textcolor{gray}{1/,10/}}} & \encabezadodorado{2020 \textsuperscript{\textcolor{gray}{1/,5/}}} & \encabezadodorado{2021 \textsuperscript{\textcolor{gray}{1/,5/}}} & \encabezadodorado{2022 \textsuperscript{\textcolor{gray}{1/,5/}}} & \encabezadodorado{2023 \textsuperscript{\textcolor{gray}{1/,5/}}} \\
    \midrule
    \endfirsthead
    ...
    \textbf{Bioenergía \textsuperscript{\textcolor{gray}{2/}}} & 375.15 & 377.95 & 377.95 & 407.826 & 406.777 \\
    ...
    \textbf{Generación Distribuida (GD) \textsuperscript{\textcolor{gray}{8/}}} &  &  &  &  &  \\
    \textbf{FIRCO \textsuperscript{\textcolor{gray}{9/}}} &  &  &  &  &  \\
    ...
    \textbf{Térmica convencional \textsuperscript{\textcolor{gray}{3/}}} & 11,830.95 & 11,808.95 & 11,792.95 & 11,342.95 & 11,300.05 \\
    \textbf{Turbogás \textsuperscript{\textcolor{gray}{4/}}} & 2,959.814 & 3,545.014 & 3,743.594 & 3,814.594 & 3,887.714 \\
  ...
  \begin{longtable}{p{3cm}p{11.00cm}}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{\textbf{TECNOLOGÍA}} & \encabezadodorado{2024 \textsuperscript{\textcolor{gray}{6/}}} \\
    \midrule
    \endfirsthead
    ...
    \textbf{Bioenergía \textsuperscript{\textcolor{gray}{2/}}} & 387.342 \\
    ...
    \textbf{Térmica convencional \textsuperscript{\textcolor{gray}{3/}}} & 11,300.05 \\
    \textbf{Turbogás \textsuperscript{\textcolor{gray}{4/}}} & 3,952.57 \\
