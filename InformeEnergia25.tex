...
\hypersetup{
  ...
  pdfcreationdate={D:20251210220101},
  pdfversion={1}
}
...
\begin{figure}[H]
  ...
  \pdftooltip{\includegraphics[width=0.8\textwidth]{img/graficos/figura_2_1.png}}{Gráfica circular (pie chart) que muestra la distribución porcentual del consumo energético en México por sector económico durante 2024. Sector industrial: 45\% (color guinda), sector transporte: 30\% (verde), sector residencial: 15\% (dorado), otros sectores: 10\% (gris). Total: 100\% equivalente a 4,250 petajoules.}
...
\begin{tabladorado}
  ...
  \begin{tabular}{p{3cm}ccc}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{\textbf{Este }} & \encabezadodorado{No} & \encabezadodorado{es  el} & \encabezadodorado{mismo} \\
    \midrule
    \textbf{Generación MW} & 1 & 2025 \textsuperscript{\hyperlink{nota1}{\textcolor{gray}{1/}}} & 2026 \textsuperscript{\hyperlink{nota2}{\textcolor{gray}{2/}}} \\
    \textbf{Distribucion MW} & 56 & 6 & 7 \\
...
\begin{figure}[H]
  \centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=0.8\textwidth]{img/graficos/figura_4_3.png}}{Gráfica circular (pie chart) que muestra la distribución porcentual del consumo energético en México por sector económico durante 2024. Sector industrial: 45\% (color guinda), sector transporte: 30\% (verde), sector residencial: 15\% (dorado), otros sectores: 10\% (gris). Total: 100\% equivalente a 4,250 petajoules.}
  \caption{Evolución de la capacidad instalada por tecnología, 2020–2025s}
  \label{fig:evolucion_de_la_capacidad_inst}
\end{figure}
\fuente{SENER,20251}
