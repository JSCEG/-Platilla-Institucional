...
\hypersetup{
  ...
  pdfcreationdate={D:20251213213417},
  pdfversion={1}
}
...
\begin{tablaguinda}
  ...
  \begin{tabular}{B{3cm}p{2cm}p{2cm}p{2cm}}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{\textbf{Tecnología}} & \encabezadodorado{Capacidad (MW)} & \encabezadodorado{Participación (\%)} & \encabezadodorado{Nota} \\
    \midrule
...
\section{Anexo A. Ejemplo de anexo}
...
\subsection{A.1 Detalle adicional}
