...
\hypersetup{
  ...
  pdfcreationdate={D:20251214112521},
  pdfversion={1}
}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabular}{H{3cm}G{2cm}G{2cm}G{2cm}}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{Tecnología} & \encabezadodorado{Capacidad (MW)} & \encabezadodorado{Participación (\%)} & \encabezadodorado{Nota} \\
    \midrule
    \textbf{Solar FV} & 12,500 & 18.5 & Ejemplo \\
    \textbf{Eólica} & 16,000 & 23.7 & Ejemplo \\
    \textbf{Hidro} & 12,000 & 17.8 & Ejemplo \\
    \textbf{Ciclo combinado} & 21,000 & 31.1 & Ejemplo \\
    \textbf{Otras} & 6,000 & 8.9 & Ejemplo \\
    \bottomrule
  \end{tabular}
...
\begin{tabladoradoLargo}
  \begin{longtable}{B{3cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}p{2.20cm}}
    ...
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{Año} & \encabezadodorado{Solar (MW)} & \encabezadodorado{Eólica (MW)} & \encabezadodorado{Hidro (MW)} & \encabezadodorado{CC (MW)} & \encabezadodorado{Total (MW)} \\
    \midrule
    \endfirsthead
...
Este nivel prueba el mapeo a \textbackslash\{\}paragraph\{...\} en el .tex.
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=0.8\textwidth]{img/graficos/figura_4_3.png}}{Gráfica de líneas con dos series (solar y eólica) a lo largo de varios años; valores crecientes.}
  \par}
  \raggedright
