...
\subtitle{Plantilla institucional completa con todas las funcionalidades}
...
\portadaseccion{Elementos de la Plantilla}{Tipografía, Estilos y Recuadros}
...
\portadaseccion{Tablas y Gráficos}{Visualización de Datos Institucionales}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{img/figura-.ejemplo.png}
...
\portadaseccion{Referencias y Anexos}{Información Complementaria}
...
\begin{itemize}
    \item \textbf{Libros:} \textcite{rodriguez2023planeacion} analizan la planeación energética.
    \item \textbf{Artículos:} El crecimiento de renovables es notable \autocite{gomez2023renovables}.
    \item \textbf{Reportes:} El \textcite{sener2024pladese} define la política sectorial.
    \item \textbf{Sitios Web:} Consulte el portal oficial \autocite{sener2024portal}.
\end{itemize}
