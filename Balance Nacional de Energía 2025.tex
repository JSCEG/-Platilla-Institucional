...
\hypersetup{
  ...
  pdfsubject={BNE 2025},
  pdfkeywords={Energía},
  pdfcreationdate={D:20251230190033},
  pdfversion={1}
}
...
\end{itemize}
% ERROR: Figura FIG-1.2-1 no encontrada
\textbf{\textcolor{red}{[Error: Figura FIG-1.2-1 no encontrada]}}
...
\begin{figure}[H]
  {\centering
  \caption{Figura 6.1 Diagrama de cascada del Balance Nacional de Energía por proceso, 2024}
  \label{fig:figura_6_1_diagrama_de_cascada}
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=0.8\textwidth]{img/figura_6_1.png}}{Figura 6.1 Diagrama de cascada del Balance Nacional de Energía por proceso, 2024}
  \par}
  \raggedright
\end{figure}
\vspace{-4pt}
